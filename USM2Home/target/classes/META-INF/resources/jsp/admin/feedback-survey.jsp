...
<div class="content-wrapper">
    ...
    <section class="content container-fluid">
        <div class="survey-card">
            ...
            <form action="/admin/feedbackSurvey/submit" method="post">
                <div class="question">
                    <span class="question-label">1. Is the website interface clear and easy to use?</span>
                    <span class="stars">
                        <label><input type="radio" name="q1UiClear" value="1" required>1</label>
                ...
                <div class="question">
                    ...
                    <span class="stars">
                        <label><input type="radio" name="q2SearchEasy" value="1" required>1</label>
                ...
                <div class="question">
                    ...
                    <span class="stars">
                        <label><input type="radio" name="q3InfoTrue" value="1" required>1</label>
                ...
                <div class="question">
                    ...
                    <span class="stars">
                        <label><input type="radio" name="q4ContactValid" value="1" required>1</label>
                ...
                <div class="question">
                    ...
                    <span class="stars">
                        <label><input type="radio" name="q5PicDesc" value="1" required>1</label>
                ...
                <div class="question">
                    ...
                    <span class="stars">
                        <label><input type="radio" name="q6FoundHouse" value="1" required>1</label>
                ...
                <div class="question">
                    ...
                    <span class="stars">
                        <label><input type="radio" name="q7FavContact" value="1" required>1</label>
                ...
                <div class="question">
                    ...
                    <span class="stars">
                        <label><input type="radio" name="q8FlowSmooth" value="1" required>1</label>
                ...
                <div class="question">
                    ...
                    <span class="stars">
                        <label><input type="radio" name="q9Satisfaction" value="1" required>1</label>
                ...
                <div class="question">
                    ...
                    <span class="stars">
                        <label><input type="radio" name="q10Recommend" value="1" required>1</label>
                ...
                <div class="question">
                    ...
                    <span class="stars">
                        <label><input type="radio" name="q11Bug" value="1" required>1</label>
