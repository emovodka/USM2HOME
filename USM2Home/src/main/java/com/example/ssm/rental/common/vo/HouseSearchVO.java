...
public class HouseSearchVO {
    ...
    /**
     * Distance range to USM, format: "min;max"
     */
    private String distanceRange = "0;999";

    /**
     * Minimum distance to USM in kilometers
     */
    private Double minDistance = 0.0;

    /**
     * Maximum distance to USM in kilometers
     */
    private Double maxDistance = 999.0;
    ...
    public String getPagePrefix() {
        ...
        stringBuilder.append("&distanceRange=").append(this.distanceRange);
