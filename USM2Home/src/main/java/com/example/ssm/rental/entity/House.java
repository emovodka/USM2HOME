...
public class House extends BaseEntity {
    ...
    /**
     * Distance to USM in kilometers
     */
    private Double distanceToUsm;
    ...
    public Double getDistanceToUsm() {
        return distanceToUsm;
    }

    public void setDistanceToUsm(Double distanceToUsm) {
        this.distanceToUsm = distanceToUsm;
    }
